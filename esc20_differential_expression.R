...
esc_seurat <- readRDS("C:/Users/panka/OneDrive/Desktop/ESC/escmerged20_seurat_object.rds")
...
# Save results
write.csv(as.data.frame(significant_results), file = "C:/Users/panka/OneDrive/Desktop/esc20(ref)RES.csv")
