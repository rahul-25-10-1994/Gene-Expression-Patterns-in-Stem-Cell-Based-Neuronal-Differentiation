...
esc_seurat <- readRDS("C:/Users/panka/OneDrive/Desktop/ESC/escmerged0_seurat_object.rds")
...
# Save results
write.csv(as.data.frame(significant_results), file = "C:/Users/panka/OneDrive/Desktop/esc(ref)RES.csv")
